...
//     select_crime(ns: NS): DeploymentBundle[] {
//         return this.__start_crime(ns, CrimeFuncs.get_best(ns, "hacking").id)
//     }
...
//     __start_crime(ns: NS, crime_name: string, force = false): DeploymentBundle[] {
//         let bundles: DeploymentBundle[] = [];
//         let player = PlayerInfo.detail(ns);
