...
test('basic', () => {
    ...
    expect(SpiralizeMatrix.solve([
        ...
        [38,25,47,41,17,13,22,34]])).toStrictEqual([47,42,14,23,27,4,3,49,39,1,5,28,48,48,34,22,13,17,41,47,25,38,27,23,47,15,32,7,44,39,44,30,33,40,36,40,46,4,40,2,45,7,15,15,30,47,21,4,33,28,11,6,50,33,36,8,5,10,5,44,1,10,6,16])
    })
