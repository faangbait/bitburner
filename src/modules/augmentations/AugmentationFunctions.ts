...
import { AugCache } from "./AugmentationCache";
import { Augmentation, AugmentationNames, Augmentations } from "./AugmentationEnums";

export const calculate_costs = (ns: NS, augmentations: Augmentation[]) => {
...
export const get_augmentation_path = (ns: NS) => {
